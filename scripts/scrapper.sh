...
PAGES=1
FILE="/home/edu/Escritorio/RENTUM/Scrapper-binaries/scrapper.txt"
FILE_BANNED="/home/edu/Escritorio/RENTUM/Scrapper-binaries/scrapper-banned.txt"
SHOW_BROWSER=false
PUBLISH=0
...
while [ $PAGES -lt 100 ]; do
	...
	java -jar scrapper.jar ${FILE} ${FILE_BANNED} "${PAGES}" ${SHOW_BROWSER} ${PUBLISH}
